...
Login();
//Checking user_role
if (in_array($_SESSION['user_role'], array(2, 5))) {
    //Redirecting to shipment
    header("Location: shipment.php");
    exit;
}
if (in_array($_SESSION['user_role'], array( 4))) {
    //Redirecting to shipment
    header("Location: dashboard_cws.php");
    exit;
}
...
//Including top_im file
            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-md-12">
                        <div class="tabsbar">
                            <ul>
                                <li class="active"><a href="#"> <b>Public Sector</b></a></li>
                                <li><a href="dashboard_private.php"> <b>Private Sector</b></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="widget-head" style="border-bottom:0;">
                        <ul>
                            ...
                            while ($row = mysql_fetch_array($stkQuery)) {
                                ...
                                $counter++;
                                ?>
                                <li <?php echo $active; ?>><a onClick="selectStk(<?php echo $counter; ?>, <?php echo $row['stkid'];?>)" href="#tab-<?php echo $counter; ?>" data-toggle="tab"><?php echo $row['stkname']; ?></a></li>
                                <?php
                            }
                            ?>
                        </ul>
    ...
    <script type="text/javascript">
		...
		function selectStk(tabId, stkId)
		{
