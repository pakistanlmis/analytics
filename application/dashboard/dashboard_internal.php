        ...
        <div class="page-content-wrapper">
            <div class="page-content">
                ...
                <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h3 class="page-title row-br-b-wp center"> <?php echo $prov_name;?> - Internal Dashboard - <?php echo date('M-Y',strtotime($fromDate)); ?></h3>
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-12 my_dash_cols">
                                    <div class="col-md-12 "  style=" ">
                                        <div class="dashlet_graph" id="dashboard_ss_b3" href='dashboard_internal_a1.php'></div>
                                    </div>
                                    <div class="col-md-12 "  style=" ">
                        ...
                        <div class="row">
                                <div class="col-md-12 my_dash_cols">
                                    <div class="col-md-6 ">
                                        <div class="col-md-12 ">
                                            <div class="dashlet_graph" id="dashboard_ss_c1" href='dashboard_internal_b1.php'></div>
                                        </div>
                                        <div class="col-md-12 ">
                                            <div class="widget1 widget-tabs">    
                                                <div class="widget-body" style="height:auto;overflow: auto;">
                                    ...
                                    <div class="col-md-6 ">
                                        <div class="col-md-12 ">
                                            <div class="dashlet_graph" id="dashboard_ss_c2" href='dashboard_internal_b2.php'></div>
                                        </div>
			...
			loadDashlets();
                        ...
                        if(!$('#accordion').hasClass('page-sidebar-menu-closed'))
                        {
                         ...
                         $(document).on("click",".pipeline_anchor",function() {
                                ...
                                var url = 'dashboard_internal_pipeline.php';
                ...
                function showDrillDown_b1(prov,prov_name,from_date,stk,stk_name) {
                   ...
                   window.open("drilldown_internal_b1_1.php?province="+prov+"&prov_name="+prov_name+"&from_date="+from_date+"&stakeholder="+stk+"&stk_name="+stk_name ,"", "width=800,height=600");
                }
                  
                function showDrillDown_b2(prov,prov_name,from_date,prod_id,prod_name) {
                   
                   window.open("drilldown_internal_b2_1.php?province="+prov+"&prov_name="+prov_name+"&from_date="+from_date+"&prod_id="+prod_id+"&prod_name="+prod_name ,"", "width=800,height=600");
                }
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Pipeline Details</h4>
            </div>
