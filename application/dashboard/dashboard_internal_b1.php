...
";
 ...
 ";
    ...
    $c=1;
     $r_arr  = $reverse_arr=$stk_arr   = $so_arr = array();
   ...
   //echo '<pre>';print_r($r_arr);print_r($reverse_arr);print_r($stk_arr);print_r($so_arr);exit;    
    ...
    //xml for chart
    $xmlstore = '<chart caption="Avg Stock Sufficiency Rate at Districts of '.$prov_name.'" yaxismaxvalue="100" subcaption="Stakeholder Wise" xaxisname="Stakeholders" yaxisname="Percentage" numberprefix="" exportEnabled="1" theme="fint">';
    $xmlstore .= ' <categories>';
