...
<div class="widget widget-tabs">    
    ...
    //xml for chart
    $xmlstore = '<chart caption="Stock Sufficiency Rate at SDPs - '.$prov_name.'" yaxismaxvalue="100"  subcaption="" xaxisname="Products" exportEnabled="1"  yaxisname="Percentage" numberprefix="" theme="fint">';
    $xmlstore .= ' <categories>';
