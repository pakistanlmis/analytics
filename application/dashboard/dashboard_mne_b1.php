...
<div class="widget widget-tabs">    
    ...
    {
        $disp_arr[$row['item_id']][$row['reporting_date']] = $row['consumption'];
    ...
    foreach($disp_arr as $itm_id => $itm_data)
    {
        ...
        foreach($months as $k => $month)
        {   
            $val=(!empty($itm_data[$month])?$itm_data[$month]:'0');
