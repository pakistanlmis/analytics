...
$selDist  = (!empty($_REQUEST['dist_id']))?$_REQUEST['dist_id']:'102';
...
<body class="page-header-fixed page-quick-sidebar-over-content">
        ...
        <div class="page-content-wrapper">
            <div class="page-content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                            <div class="col-md-12">
                                <h3 class="page-title row-br-b-wp center"> <?php echo $prov_name;?> - <?php echo $dist_name;?> - District Stock Sufficiency Dashboard - <?php echo date('M-Y',strtotime($fromDate)); ?></h3>
    ...
    <script type="text/javascript">
		...
		$(function() {
			loadDashlets();
                        ...
                        $(document).on("click",".soh_anchor",function() {
                                $('#soh_modal').modal('show');
                            
                                var url = 'dashboard_ss_dist_soh.php';
				var id = 'soh_modal_graph';
		...
		function showDistricts() {
			$.ajax({
				type: "POST",
				url: '<?php echo APP_URL; ?>dashboard/ajax.php',
				data: {lvl: 3, prov_id: $('#province').val()},
				success: function(data) {
					$("#td_dist").html(data);
				}
			});
 ...
 <div class="modal fade" id="soh_modal" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title">Stock On Hand Details</h4>
            </div>
            <div class="modal-body" id="soh_modal_body">
                <div class="col-md-12 "  style=" ">
                    <div class="" id="soh_modal_graph" ></div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn dark btn-outline" data-dismiss="modal">Close</button>
