...
$email = $cell = '';
                	...
                	tbl_warehouse.wh_id,
                        ...
                        (
                                ...
                                WHERE
                                    ...
                                    alerts_log.warehouse_id = tbl_warehouse.wh_id 
 ...
 ";
   if($province!='all') 
    ...
    $qry.=" ORDER BY  tbl_warehouse.wh_name ";
    //echo $qry;exit;
    ...
    $qry2 = "SELECT
            ...
            WHERE
                ...
                mosscale_tab.stkid = $stakeholder
            ";
    if($province!='all') 
        $qry2 .= "  AND itminfo_tab.itm_id = '".$prod_id."' ";
    ...
    $c=1;
     ...
     echo '<b><span class="btn yellow-gold">'.$dist_name.'  - '.$stk_name.'  - '.$prod_name.'</span></b>';
     ...
     echo '<div class="row">';
    echo '<div class="col-md-12"  style=" height: 430px; overflow-y: scroll;">';
    ?>
<a href="../reports/stock_optimization.php?stakeholder=<?=$stakeholder?>&prov_sel=<?=$province?>&dist_id=<?=$dist_id?>&product=<?=$prod_id?>&submit=Submit&date=<?=$from_date?>" target="_blank" class="btn btn-xs green right pull-right">Analysis for Stock Optimization</a>
