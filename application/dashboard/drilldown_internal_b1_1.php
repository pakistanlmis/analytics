...
";
 ...
 ";
    ...
    foreach($so_arr as $itm_id => $val)
    {
            ...
            $r_arr[$itm_id] = $perc;
            $reverse_arr[$itm_id] = 100-$perc;
           
    }
    //echo '<pre>'.$total_districts;print_r($r_arr);print_r($so_arr);print_r($itm_arr);exit;    
        
    //xml for chart
    $xmlstore = '<chart caption="Stock Sufficiency Rate at Districts of '.$prov_name.' - '.$stk_name.'" yaxismaxvalue="100"  subcaption="Product Wise" xaxisname="Products" yaxisname="Percentage" numberprefix="" exportEnabled="1" theme="fint">';
    $xmlstore .= ' <categories>';
    ...
    $xmlstore .= ' <dataset seriesname="Avg Stock Sufficiency Rate at Districts">';
 ...
 $xmlstore .= ' </chart>';
    ...
    <script>
     ...
     function showDrillDown_lvl2(prov,prov_name,from_date,stk,stk_name,prod_id,prod_name) {
        ...
        var url = 'drilldown_internal_b1_2.php';
