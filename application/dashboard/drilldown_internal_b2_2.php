...
<div class="widget widget-tabs">    
    ...
    //xml for chart
    $xmlstore = '<chart caption="Stock Sufficiency Rate at SDPs - '.$prov_name.' - '.$stk_name.' - '.$prod_name.'" yaxismaxvalue="100"  subcaption="" xaxisname="Districts" yaxisname="Percentage" numberprefix="" theme="fint">';
    $xmlstore .= ' <categories>';
...
<script>
     ...
     function showDrillDown_lvl3(prov,prov_name,from_date,stk,stk_name,prod_id,prod_name,dist_id,dist_name) {
        ...
        var url = 'drilldown_internal_b2_3.php';
