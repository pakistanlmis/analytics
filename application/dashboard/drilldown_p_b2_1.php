...
<div class="widget widget-tabs">    
    ...
    //xml for chart
    $xmlstore = '<chart caption="Stock Out Rate at SDPs - '.$prov_name.' - '.$prod_name.'" yaxismaxvalue="100"  subcaption="" xaxisname="Products" yaxisname="Percentage" numberprefix="" theme="fint">';
    $xmlstore .= ' <categories>';
    ...
    $xmlstore .= ' <dataset seriesname="Stock Out Rate at SDPs">';
