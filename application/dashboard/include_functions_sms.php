...
function func_send_sms_for_moderation($to,$subject,$msg,$cc="",$page_name,$wh_id='',$sent_by_user,$sent_to_user,$district_id){
        ...
        $mail_subject = 'SMS for Moderation From '.$sent_by_info['sysusr_name'].' ,To '.$sent_to_info['sysusr_name'];
        $msg_body_orig = addslashes($msg);
         ...
         $log_q = "INSERT INTO moderation (
                     ...
                     VALUES ('$to','$cc','$wh_id','$subject','$sent_by_user','$sent_to_user','','SMS','$page_name','pending')";
//        echo $log_q;
         mysql_query($log_q);
        ...
        $message = '
                 ...
                 <body>Following <b>SMS</b> was generated from LMIS System . It is presented before you for moderation.
                    <br/>
                    ...
                    <table border = "1">
                        ...
                        <tr><td>SMS Message :</td><td><p style="color:blue">'.nl2br($msg_body_orig).'</p></td></tr> 
                        <tr>
...
function func_shoot_sms($to,$subject,$msg,$cc="",$page_name,$wh_id='',$insert_log=TRUE,$sent_by_user,$sent_to_user,$from="feedback@lmis.gov.pk",$reply_to="feedback@lmis.gov.pk"){
        ...
        $response2 = $resultQuick2->QuickSMSResult;
        ...
        if($insert_log)
        {
           $log_q = "INSERT INTO alerts_log (
                        ...
                        VALUES ('$to','$cc','$wh_id','','$sent_by_user','$message','','SMS','$page_name')";
              //echo $log_q;exit;
            mysql_query($log_q);
       }
}
