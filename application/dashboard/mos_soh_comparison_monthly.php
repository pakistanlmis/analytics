...
$toDate = (!empty($_REQUEST['to_date']))?$_REQUEST['to_date']:date("Y-m-d");
                                        ...
                                        <table width="100%">
                                            ...
                                            <tr>
                                                <td class="col-md-2">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="text" name="from_date" id="from_date"  class="form-control input-sm" value="<?php echo $fromDate; ?>" readonly required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <td class="col-md-2">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="text" name="to_date" id="to_date"  class="form-control input-sm" value="<?php echo $toDate; ?>" readonly required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <td class="col-md-2 filter1" id="td_dist" style=""><label class="sb1NormalFont">District</label>
                                                    <select name="dist_id" id="dist_id" class="form-control input-sm" required="">
                                                            <?php
                                                            $queryDist = "SELECT
...
";
                      ...
                      <div class="row hide_divs">
                        ...
                        <div class="col-md-12 "  style=" ">
                            <div class="dashlet_graph_html" id="dashboard_ss_a1" href='mos_soh_comparison_graph_monthly.php'></div>
                        </div>
