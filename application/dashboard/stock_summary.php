  ...
  $qry = "SELECT
    ...
    RIGHT JOIN (
        ...
        WHERE
         ...
         /*AND itminfo_tab.itm_category IN (1,4)*/
...
while ($row = mysql_fetch_array($qryRes)) {
    ...
    if (!empty($row['FundingSource']) && $fundingSource != 'all') {
...
//include footer
    ...
    <script>
        ...
        function doInitGrid() {
            ...
            mygrid.setHeader("<div style='text-align:center; font-size:14px; font-weight:bold;'><?php echo $funding_s; ?> - Stock Summary (<?php echo $fromDate . '  to' . $toDate; ?>)</div>,#cspan,#cspan,#cspan,#cspan,#cspan,#cspan,#cspan,#cspan");
